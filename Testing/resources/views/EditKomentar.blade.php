...
<body>
    ...
    <div class="layar-penuh">
        ...
        <br>
        <br>
        <h3 style="text-align: center;font-size:25px;padding-left:9px;">Edit Komentar</h3>
        <br>
        <form action="/post/comment/{{ $comment->id }}/edit" method="POST" enctype="multipart/form-data">
            @method('put')
            @csrf
            <br>
            ...
            <div class="d-flex w-100">
                <div class="form-outline w-100">
                    <textarea class="form-control" id="nama" name="body" rows="12" style="background: #fff;">{{ $comment->body }}</textarea>
                </div>
            </div>
            <br>
