...
<body>
    ...
    <div class="popup-form" id="popup-buat">
        <div class="popupcontent-form">
            ...
            <form action="/post" method="POST" enctype="multipart/form-data" style="margin-left: 10px;margin-right:10px;">
            @csrf
                <h4 style="margin-top: 20px;text-align:center;">Buat Postingan</h4>
                <input type="hidden" name="user_id" class="form-control" value="{{ $user->id }}">
                <input type="text" id="name" name="title" placeholder="Judul" style="margin-bottom: 15px;">
                <textarea id="desc" name="body" placeholder="Apa yang anda pikirkan ?" style="margin-bottom: 15px;"></textarea>
                {{-- <button class="normal" type="submit" style="margin-bottom: 20px;">Kirim2</button> --}}
                
                <a href="#" value="Kirim" style="justify-content: center; margin-left:40%;"><button class="normal" type="submit" style="margin-bottom: 20px;">Kirim</button></a>
            </form>
        </div>
    </div>
    ...
    {{-- <div class="popup-form" id="popup-hapus">
        <div class="popupcontent-form">
            ...
            @csrf
                ...
                <button class="normal" style="margin-bottom: 20px;">Hapus
                </button>
            </form>
    ...
    {{-- <form action="???" method="post" enctype="multipart/form-data" style="margin-left: 10px;margin-right:10px;">
        <h5 style="margin-top: 20px;text-align:center;margin-left:5%;;">Apakah Anda Yakin Ingin Menghapus Postingan Tersebut ?</h5>
        <a href="#" value="Kirim" style="justify-content: center; margin-left:40%;"><button class="normal" style="margin-bottom: 20px;">Hapus</button></a>
    </form> --}}
    ...
    <!-- BUAT POSTINGAN BARU -->
    <a href="#popup-buat" style="margin-left: 5%;"><button class="normal">+   Start a New Topic</button></a>
    ...
    <footer id = "contact">
            ...
            <div class = "layar-dalam">
                ...
                <div class="footerpembayaran">
                    <h5 onclick="window.location.href='/profil/setting'" style="font-weight: 400;cursor:pointer;">Pengaturan</h5>
                </div>
                <div class="footers">
